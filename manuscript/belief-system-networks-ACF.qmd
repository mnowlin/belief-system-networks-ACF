...
At the top of the hierarchy are deep core beliefs such as political ideology or environmental orientation. Deep core beliefs are foundational values that are sufficiently abstract that they can inform views regarding a variety of policy issues. Additionally, deep core beliefs are "central" beliefs in the @converseNatureBeliefSystems1964a sense and, therefore, are resistant to change. Deep core beliefs inform policy core and secondary beliefs, and act as filters for how information relevant to a subsystem is processed [@kahanCulturalCognitionConception2012; @nowlinPolicyLearningInformation2021]. While deep core belief have been measured in various ways, increasingly scholars are using the concepts of cultural worldviews developed from cultural theory to conceptualize and measure deep core beliefs within the ACF [@ripbergerCulturalTheoryMeasurement2014; @jenkins-smithBeliefSystemContinuity2014; @hornungPartyIdentificationCultural2021; @sotirovCognitiveTheoryShifting2016; @nohrstedtAdvocacyCoalitionFramework2023]. 
...
Next, I explore the belief networks of two climate change coalitions. I use the policy core measures regarding climate change to construct the coalitions because the ACF posits that policy core beliefs are what bind coalitions together [@nohrstedtAdvocacyCoalitionFramework2023]. 
...
Given the small sample sizes of the two coalitions, there is a lot of uncertainty surrounding the estimates of centrality. However, the ranking of the various centrality values can provide some sense of the relative importance of each belief in the two networks. Looking to the measures of centrality, we see that secondary beliefs have the highest levels of centrality in both coalitions. For the skeptic coalition, as can be seen in @fig-lrC,  the international agreement measure had the highest betweenness and closeness centrality while the carbon tax measure has the highest strength centrality, whereas for the consensus coalition, shown in @fig-hrC, renewable energy support followed by support for EPA regulations had the highest level of betweenness, closeness, and strength centrality. Deep core beliefs also had high levels of centrality in both coalitions with egalitarianism high in both and political ideology high in the skeptic coalition.  
...
In this paper, I conceptualized and measured belief systems as a network, and demonstrated the utility of such an approach to belief systems in the ACF. A major strength of this approach is that it measures the role and importance of various beliefs based on centrality rather than the more limiting approach to the roles that beliefs can play in a hierarchical belief system. Using original survey data from a representative sample of the US public, I examined the belief system network associated with climate change, created two idealized climate change coalitions, and compared the belief system networks of the two coalitions. 

I found that the beliefs that were most central, depending on the centrality measure, included deep core, policy core, and secondary beliefs. Looking at the centrality measures for the entire sample, I found that cultural worldviews (deep core belief), support for various policy approaches (secondary beliefs), and perceptions of the risks posed by climate change (policy core beliefs) were the most central types of beliefs in the network. For the measures of closeness and betweenness centrality, egalitarianism was the most central node in the climate change belief network. Closeness and betweenness centrality both address the lengths of the paths between nodes, with closeness meaning that a node influences other nodes because of its short path and betweenness meaning that a node is influential because it sits on the path between other nodes. Beliefs high in closeness and betweenness act as gateways to other beliefs. These findings are consistent with the notion of cultural worldviews being deep core beliefs that influence other beliefs. Egalitarianism in particular has been shown to be associated with environmental and climate change views [@ellisSeeingGreenCultural1997; @grendstadCulturalTheoryPostmaterialism1997; @jonesLeadingWayCompromise2011; @nowlinCulturalTheoryPartisanship2020; @xueCulturalWorldviewsEnvironmental2014; @nowlinWhoShouldMore2022]. Additionally, the betweenness centrality finding of egalitarianism is also consistent with cultural cognition, where cultural worldviews shape not only _what_ people think but also _how_ people think and process information about political and policy concerns [@kahanCulturalCognitionConception2012; @kahanCulturalCognitionScientific2011; @kahanPolarizingImpactScience2012]. 
...
I also examined the beliefs of two constructed climate change coalitions, including a skeptic coalition and a consensus coalition. Overall, the networks has a similar structure with no significant difference between the edges of the two networks. This indicates that the networks had similar  

Regarding centrality, I found that secondary beliefs and egalitarianism were the most central in both coalitions. For the skeptic coalition, views on the two most polarized policy solutions -- international agreement and a carbon tax -- had the highest degrees of closeness and strength centrality, with egalitarianism and an international agreement with the highest betweenness centrality. Support for renewable energy and EPA regulations had the highest values on each centrality measure for the consensus coalition. Additionally, the skeptic coalition was less dense and had fewer connections than the consensus coalition, reflecting previous research that found more variability of climate change beliefs among Republicans and conservatives [@jenkins-smithPartisanAsymmetryTemporal2020]. 
...
The results examining the two coalitions provided insights regarding the belief system of the coalitions that a hierarchical approach might not have.  

solution aversion and the importance of polarized policy approaches in driving coalition dynamics. 
<!-- inhoffe quote about agreeing before solutions were discussed -->

solution aversion and secondary beliefs 

skeptic coalition, less connected international agreement and carbon tax most central beliefs; highly polarized; coalition shaped by opposition to policy proposals  



In brief, the skeptic coalition is .
