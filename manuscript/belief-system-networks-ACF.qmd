...
<!-- **Abstract**: The Advocacy Coalition Framework (ACF) is one of the most prominent policy process theories. A central component of the ACF is belief systems. Beliefs are understood as hierarchical with deep core beliefs constraining policy core beliefs and secondary beliefs (beliefs regarding particular issues and policy domains) and policy attitudes, which are beliefs about particular policies and are constrained by both core and policy domain beliefs. However, fuzzy boundaries exist between the different types of beliefs within hierarchical belief systems. Additionally, the function that beliefs play may vary across different subsystems. Recent work has noted that belief systems can be understood as a network of connected beliefs. In a belief system network, the beliefs are the nodes and the edges are the correlations between the beliefs. Understanding belief systems as networks shifts the focus from the belief's position in the hierarchy to its centrality in the network. Examining the centrality of a belief in a network make its function clearer. Using a survey of a nationally representative sample of the US public, I explore the belief system network associated with climate change. Specifically, I examine connections between measures of deep core, policy core, and secondary beliefs. Deep core beliefs include cultural worldviews (hierarch, egalitarianism, individualism, fatalism), political ideology, partisanship, and the New Ecological Paradigm Scale (NEP). Policy core beliefs include views on climate change (it's happening, it's a risk, and there is a scientific consensus), and secondary beliefs include support for various climate policies. In addition, I use three network centrality measures, including betweenness, closeness, and strength to see which beliefs are the most central in the belief network. Examining the entire sample, I find that cultural worldviews, particularly egalitarianism; support for climate policies, particularly EPA regulations; and the perception of risk associated with climate change are the most central beliefs in the network. Then, I construct two climate change coalitions -- a skeptic coalition and a consensus coalition -- based on policy core beliefs and found that secondary beliefs were the most central in each of the coalitions. I conclude with a discussion of the implications for the ACF of conceptualizing and measures belief systems as networks.   
...
Next, I use the policy core measures to construct and explore the belief networks of two idealized climate change coalitions.
...
To illustrate two possible climate change coalitions, I use the policy core belief measures of climate change, as the ACF posits that policy core beliefs are what bind coalitions together. The policy core beliefs include whether climate change is happening and certainty that it is/is not happening; perceived risk of climate change; and whether or not there is a scientific consensus regarding climate change. Specifically, I constructed a _skeptic_ climate change coalition consisting of those in the first quantile of the climate change is happening measure (<= 2 on the -4 to 4 scale), the first quantile of the risk posed by climate change measures (<= 5 on the 0 to 10 scale), and those that thought there is not a science consensus regarding climate change. Next, I constructed a  _consensus_ coalition consisting of those in the third quantile of the climate change is happening (a 4 on the -4 to 4 scale) and climate change risk distribution (>= 9 on the 0 to 10 scale) as well as those who believe there is a scientific consensus. Overall, there were `r nrow(lowRiskData)` respondents in the skeptic coalition and `r nrow(highRiskData)` respondents in the consensus coalition. 

First, I compare the deep core and secondary beliefs of the two coalitions. @tbl-beliefs shows the means and significant differences.    
...
As shown in @tbl-beliefs, the consensus coalition is more egalitarian, more fatalist, more concerned about the environment, more liberal, and more Democratic than the skeptic coalition. However, there are no significant differences between the coalitions on hierarchy and individualism. Additionally, the consensus coalition is more supportive of all the climate policy measures than the skeptic coalition, with the exception of nuclear energy. Yet, some of the policy measures are more polarized than others. Support for an international agreement is the most polarized, with a difference of `r round(mean(highRiskData$IntAgree, na.rm=TRUE)-mean(lowRiskData$IntAgree, na.rm=TRUE),3)` on the seven-point scale. This is likely because the debate over the Kyoto Protocol in 1997 was a major contributor to the polarization of climate change in the US [@krosnickImpactFall19972000]. The next most polarized policy was a carbon tax with a difference of `r round(mean(highRiskData$Tax, na.rm=TRUE)-mean(lowRiskData$Tax, na.rm=TRUE),2)`, followed by EPA regulations with a difference of `r round(mean(highRiskData$EPA, na.rm=TRUE)-mean(lowRiskData$EPA, na.rm=TRUE),2)`, cap-and-trade at `r round(mean(highRiskData$CapTrade, na.rm=TRUE)-mean(lowRiskData$CapTrade, na.rm=TRUE),2)`, and geoengineering at `r round(mean(highRiskData$GeoEng, na.rm=TRUE)-mean(lowRiskData$GeoEng, na.rm=TRUE),2)`. The least polarized policy was expanding renewable energy at a difference of `r round(mean(highRiskData$Renew, na.rm=TRUE)-mean(lowRiskData$Renew, na.rm=TRUE),2)`. Finally, there were no significant differences between the coalitions on support for nuclear energy.  
...
Given the small sample sizes of the two coalitions, there is a lot of uncertainty surrounding the estimates of centrality. However, the ranking of the various centrality values can provide some sense of the relative importance of each belief in the two networks. Looking at the measures of centrality, we see that secondary beliefs have the highest levels of centrality in both coalitions. For the skeptic coalition, as can be seen in @fig-lrC,  the international agreement measure had the highest betweenness and closeness centrality while the carbon tax measure has the highest strength centrality, whereas for the consensus coalition, shown in @fig-hrC, renewable energy support followed by support for EPA regulations had the highest level of betweenness, closeness, and strength centrality. Deep core beliefs also had high levels of centrality in both coalitions, with egalitarianism high in both and political ideology high in the skeptic coalition.  
...
Finally, I examined differences in the three centrality measures across the two networks. For betweenness centrality, ideology and support for geoengineering had significantly higher degrees of centrality at _p_<0.05 in the skeptic coalition than the consensus coalition. Regarding ideology, this result shows that political ideology is more of a connecting belief in the network for the skeptic coalition than it is for the consensus coalition. Geoengineering is an interesting result; however, it is not particularly high in betweenness in either coalition, even as it is higher in the skeptic coalition. There were four nodes, representing deep core beliefs, that were significantly different between the two networks on closeness centrality, including ideology and partisanship, which were higher in the skeptic coalition as well as fatalism and the NEP scale, which were higher in the consensus coalition. These results indicate that political beliefs are more salient in the skeptic coalition, whereas fatalism and environmental beliefs are more salient in the consensus coalition. For strength centrality, hierarchy, NEP scale, and support for nuclear energy had higher degrees of strength centrality in the consensus coalition than the skeptic coalition, whereas support for a carbon tax had higher strength centrality in the skeptic coalition. 
